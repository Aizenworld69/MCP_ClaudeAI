# 🚀 HƯỚNG DẪN CẤU HÌNH GOOGLE ADS MCP CHO CLAUDE DESKTOP (TỪ A-Z)

Tài liệu này hướng dẫn chi tiết từng bước cách cấu hình và tích hợp **Google Ads MCP Server** vào **Claude Desktop**. Bạn có thể gửi file này cho bất kỳ ai để làm theo tương tự.
